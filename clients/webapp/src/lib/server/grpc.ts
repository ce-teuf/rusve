...
import { USERS_URI, NOTES_URI, UTILS_URI, SCRAPER_URI, GRPC_SSL } from "$env/static/private";
...
export const scraperService = new proto.proto.ScraperService(SCRAPER_URI, cr);
