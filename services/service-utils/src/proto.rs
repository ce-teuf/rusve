...
pub struct Source {
    ...
    /// "AUTO" | "MANUAL"
    #[prost(string, tag = "7")]
    pub integration_mode: ::prost::alloc::string::String,
    /// cron expression e.g. "0 2 * * \*"
    #[prost(string, tag = "8")]
    pub auto_schedule: ::prost::alloc::string::String,
    /// JSON-serialized array of FieldRule
    #[prost(string, tag = "9")]
    pub field_rules: ::prost::alloc::string::String,
    #[prost(bool, tag = "10")]
    pub active: bool,
}
#[derive(serde::Serialize, serde::Deserialize)]
...
pub struct Item {
    ...
    /// PENDING | VALID | INVALID | APPROVED | REJECTED | PUSHED
    #[prost(string, tag = "6")]
    pub validation_status: ::prost::alloc::string::String,
    /// JSON-serialized array of strings
    #[prost(string, tag = "7")]
    pub validation_errors: ::prost::alloc::string::String,
    #[prost(string, tag = "8")]
    pub pushed_at: ::prost::alloc::string::String,
    #[prost(string, tag = "9")]
    pub pushed_target: ::prost::alloc::string::String,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub mod users_service_server {
                ...
                "/proto.UsersService/CreateUser" => {
                    ...
                    for CreateUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as UsersService>::create_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.UsersService/Auth" => {
                    ...
                    for AuthSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UsersService>::auth(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.UsersService/GetProfileByUserId" => {
                    ...
                    for GetProfileByUserIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UsersService>::get_profile_by_user_id(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/proto.UsersService/CreateProfile" => {
                    ...
                    for CreateProfileSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UsersService>::create_profile(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.UsersService/CreateStripeCheckout" => {
                    ...
                    for CreateStripeCheckoutSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UsersService>::create_stripe_checkout(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/proto.UsersService/CreateStripePortal" => {
                    ...
                    for CreateStripePortalSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UsersService>::create_stripe_portal(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "proto.UsersService";
...
pub mod notes_service_server {
    ...
    #[async_trait]
    pub trait NotesService: std::marker::Send + std::marker::Sync + 'static {
        async fn count_notes_by_user_id(
            &self,
            request: tonic::Request<super::Empty>,
        ) -> std::result::Result<tonic::Response<super::Count>, tonic::Status>;
        /// Server streaming response type for the GetNotesByUserId method.
        type GetNotesByUserIdStream: tonic::codegen::tokio_stream::Stream<
    ...
    #[derive(Debug)]
    pub struct NotesServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
                ...
                "/proto.NotesService/CountNotesByUserId" => {
                    ...
                    for CountNotesByUserIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotesService>::count_notes_by_user_id(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/proto.NotesService/GetNotesByUserId" => {
                    ...
                    for GetNotesByUserIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotesService>::get_notes_by_user_id(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/proto.NotesService/GetNoteById" => {
                    ...
                    for GetNoteByIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotesService>::get_note_by_id(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.NotesService/CreateNote" => {
                    ...
                    for CreateNoteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotesService>::create_note(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.NotesService/DeleteNoteById" => {
                    ...
                    for DeleteNoteByIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotesService>::delete_note_by_id(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for NotesServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "proto.NotesService";
    impl<T> tonic::server::NamedService for NotesServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod utils_service_server {
    ...
    #[async_trait]
    pub trait UtilsService: std::marker::Send + std::marker::Sync + 'static {
        async fn count_emails_by_target_id(
            &self,
            request: tonic::Request<super::Empty>,
        ) -> std::result::Result<tonic::Response<super::Count>, tonic::Status>;
        /// Server streaming response type for the GetEmailsByTargetId method.
        type GetEmailsByTargetIdStream: tonic::codegen::tokio_stream::Stream<
        ...
        type GetFilesByTargetIdStream: tonic::codegen::tokio_stream::Stream<
        ...
        type GetFileByIdStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::File, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
    ...
    #[derive(Debug)]
    pub struct UtilsServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
                ...
                "/proto.UtilsService/CountEmailsByTargetId" => {
                    ...
                    for CountEmailsByTargetIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::count_emails_by_target_id(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/proto.UtilsService/GetEmailsByTargetId" => {
                    ...
                    for GetEmailsByTargetIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::get_emails_by_target_id(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/proto.UtilsService/SendEmail" => {
                    ...
                    for SendEmailSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::send_email(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.UtilsService/CountFilesByTargetId" => {
                    ...
                    for CountFilesByTargetIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::count_files_by_target_id(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/proto.UtilsService/GetFilesByTargetId" => {
                    ...
                    for GetFilesByTargetIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::get_files_by_target_id(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/proto.UtilsService/GetFileById" => {
                    ...
                    for GetFileByIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::get_file_by_id(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.UtilsService/UploadFile" => {
                    ...
                    for UploadFileSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::upload_file(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.UtilsService/DeleteFileById" => {
                    ...
                    for DeleteFileByIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UtilsService>::delete_file_by_id(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for UtilsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "proto.UtilsService";
    impl<T> tonic::server::NamedService for UtilsServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod scraper_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ScraperServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ScraperServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn list_sources(
            ...
            tonic::Response<tonic::codec::Streaming<super::Source>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/ListSources",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "ListSources"));
            self.inner.server_streaming(req, path, codec).await
        }
        pub async fn get_source(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/GetSource",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "GetSource"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn create_source(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/CreateSource",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "CreateSource"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update_source(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/UpdateSource",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "UpdateSource"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete_source(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/DeleteSource",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "DeleteSource"));
            self.inner.unary(req, path, codec).await
        }
        /// ── Jobs ─────────────────────────────────────────────────────
        pub async fn list_jobs(
            ...
            tonic::Response<tonic::codec::Streaming<super::JobResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/ListJobs",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "ListJobs"));
            self.inner.server_streaming(req, path, codec).await
        }
        pub async fn get_job_by_id(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/GetJobById",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "GetJobById"));
            self.inner.unary(req, path, codec).await
        }
        /// ── Items ────────────────────────────────────────────────────
        pub async fn list_items(
            &mut self,
            request: impl tonic::IntoRequest<super::ItemFilter>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/ListItems",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "ListItems"));
            self.inner.server_streaming(req, path, codec).await
        }
        pub async fn approve_item(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/ApproveItem",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "ApproveItem"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn reject_item(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/RejectItem",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "RejectItem"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn approve_all_valid(
            &mut self,
            request: impl tonic::IntoRequest<super::Id>,
        ) -> std::result::Result<tonic::Response<super::Count>, tonic::Status> {
            self.inner
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/ApproveAllValid",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "ApproveAllValid"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn push_approved(
            &mut self,
            request: impl tonic::IntoRequest<super::Id>,
        ) -> std::result::Result<tonic::Response<super::Count>, tonic::Status> {
            self.inner
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/proto.ScraperService/PushApproved",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proto.ScraperService", "PushApproved"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod scraper_service_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ScraperServiceServer.
    #[async_trait]
    pub trait ScraperService: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the ListSources method.
        type ListSourcesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::Source, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// ── Sources ──────────────────────────────────────────────────
        async fn list_sources(
            ...
            tonic::Response<Self::ListSourcesStream>,
            tonic::Status,
        >;
        async fn get_source(
            &self,
        ...
        async fn create_source(
            &self,
            request: tonic::Request<super::Source>,
        ) -> std::result::Result<tonic::Response<super::Source>, tonic::Status>;
        ...
        /// Server streaming response type for the ListJobs method.
        type ListJobsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::JobResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// ── Jobs ─────────────────────────────────────────────────────
        async fn list_jobs(
            &self,
            request: tonic::Request<super::Page>,
        ) -> std::result::Result<tonic::Response<Self::ListJobsStream>, tonic::Status>;
        async fn get_job_by_id(
            &self,
            request: tonic::Request<super::Id>,
        ) -> std::result::Result<tonic::Response<super::Job>, tonic::Status>;
        /// Server streaming response type for the ListItems method.
        type ListItemsStream: tonic::codegen::tokio_stream::Stream<
        ...
        async fn list_items(
            &self,
            request: tonic::Request<super::ItemFilter>,
        ) -> std::result::Result<tonic::Response<Self::ListItemsStream>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ScraperServiceServer<T>
    where
        T: ScraperService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/proto.ScraperService/ListSources" => {
                    ...
                    for ListSourcesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::list_sources(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.ScraperService/GetSource" => {
                    #[allow(non_camel_case_types)]
                    struct GetSourceSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Id>
                    for GetSourceSvc<T> {
                        type Response = super::Source;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::get_source(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.ScraperService/CreateSource" => {
                    #[allow(non_camel_case_types)]
                    struct CreateSourceSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Source>
                    for CreateSourceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::create_source(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.ScraperService/UpdateSource" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateSourceSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Source>
                    for UpdateSourceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::update_source(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.ScraperService/DeleteSource" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSourceSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Id>
                    for DeleteSourceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::delete_source(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.ScraperService/ListJobs" => {
                    #[allow(non_camel_case_types)]
                    struct ListJobsSvc<T: ScraperService>(pub Arc<T>);
                    impl<
                        T: ScraperService,
                    > tonic::server::ServerStreamingService<super::Page>
                    for ListJobsSvc<T> {
                        type Response = super::JobResponse;
                        type ResponseStream = T::ListJobsStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::list_jobs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.ScraperService/GetJobById" => {
                    #[allow(non_camel_case_types)]
                    struct GetJobByIdSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Id>
                    for GetJobByIdSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::get_job_by_id(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetJobByIdSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/proto.ScraperService/ListItems" => {
                    #[allow(non_camel_case_types)]
                    struct ListItemsSvc<T: ScraperService>(pub Arc<T>);
                    impl<
                        T: ScraperService,
                    > tonic::server::ServerStreamingService<super::ItemFilter>
                    for ListItemsSvc<T> {
                        type Response = super::Item;
                        type ResponseStream = T::ListItemsStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::list_items(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/proto.ScraperService/ApproveItem" => {
                    #[allow(non_camel_case_types)]
                    struct ApproveItemSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Id>
                    for ApproveItemSvc<T> {
                        type Response = super::Item;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::approve_item(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ApproveItemSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/proto.ScraperService/RejectItem" => {
                    #[allow(non_camel_case_types)]
                    struct RejectItemSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Id>
                    for RejectItemSvc<T> {
                        type Response = super::Item;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::reject_item(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RejectItemSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/proto.ScraperService/ApproveAllValid" => {
                    #[allow(non_camel_case_types)]
                    struct ApproveAllValidSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Id>
                    for ApproveAllValidSvc<T> {
                        type Response = super::Count;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::approve_all_valid(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ApproveAllValidSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/proto.ScraperService/PushApproved" => {
                    #[allow(non_camel_case_types)]
                    struct PushApprovedSvc<T: ScraperService>(pub Arc<T>);
                    impl<T: ScraperService> tonic::server::UnaryService<super::Id>
                    for PushApprovedSvc<T> {
                        type Response = super::Count;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ScraperService>::push_approved(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PushApprovedSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for ScraperServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "proto.ScraperService";
    impl<T> tonic::server::NamedService for ScraperServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
